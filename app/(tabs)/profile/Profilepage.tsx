      ...
      <View style={styles.body}>
        ...
        <View style={{ borderTopWidth: 1, marginTop: 20, borderColor: "gray" }}>
          <ScrollView>
            ...
            >
              <AntDesign name="creditcard" color="#e74c3c" size={24} />
              <Text
                style={{
                  marginStart: 16,
                  fontSize: 16,
            ...
            <TouchableOpacity
              style={{ flex: 1, flexDirection: "row", paddingVertical: 16 }}
            >
              <FontAwesome5 name="shield-virus" color="#e74c3c" size={24} />
              <Text
                style={{
                  marginStart: 16,
                  fontSize: 16,
            ...
            <TouchableOpacity
              style={{ flex: 1, flexDirection: "row", paddingVertical: 16 }}
            >
              <Entypo name="users" color="#e74c3c" size={24} />
              <Text
                style={{
                  marginStart: 16,
                  fontSize: 16,
            ...
            <TouchableOpacity
              style={{ flex: 1, flexDirection: "row", paddingVertical: 16 }}
            >
              <AntDesign name="setting" color="#e74c3c" size={24} />
              <Text
                style={{
                  marginStart: 16,
                  fontSize: 16,
            ...
            <TouchableOpacity
              style={{ flex: 1, flexDirection: "row", paddingVertical: 16 }}
            >
              <AntDesign name="logout" color="#e74c3c" size={24} />
              <Link
                href="/signin/"
                style={{
                  marginStart: 16,
